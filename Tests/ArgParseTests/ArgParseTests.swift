...
class ArgParseTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testPositionalWithArity", testVariadicPositionalWithArity),
        ("testPositionalWithDefault", testPositionalWithDefault),
        ("testPositionalWithDefault", testPositionalWithAutoConversion),
        ("testPositionalWithDefault", testPositionalWithCustomConversion),
        ("testOption", testOption),
        ("testOptionWithAlias", testOptionWithAlias),
        ("testRequiredOption", testRequiredOption),
        ("testVariadicOption", testVariadicOption),
        ("testOptionWithArity", testVariadicOptionWithArity),
